...
| **context.ranges** {opening {low, high, formed_over, status \| still_forming}, in_force {low, high, froze_at, standing_for_min, is_the_opening_box (strikes-3, item #13: was formed_over + live_spot_is) \| still_forming, since, replaced_a_box_broken_at}, breaks_today {count, breaks [{at, went, box_low, box_high, back_inside_at (strikes-3, item #12)}]}, prior_sessions {sessions, from, to, low, high, measured_from, live_spot_is, today_traded_beyond_it, todays_opening_box_is}} | today's scans + the prior 5 sessions' diary files (never today's own) | **NEW obs-4 (09-02)**: the day as boxes. Opening box = first 30 min; a frozen box breaks past 0.05σ (strikes-3: past the move bar, two typical minutes as they stood at that minute; no minute record, no break); a break starts a new box that forms over 30 min. LIVE-TAPE sourced, so it survives a stale book. Box edges are admitted as pointable levels. |
