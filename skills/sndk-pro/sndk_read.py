...
A CORRECTION OF AN EARLIER READING IS AN OBSERVATION, NOT A JUDGEMENT, and this is the one case reviewers get wrong. The writer speaks every twenty minutes and is expected to un-say what the board has since taken back. "The pile I drew at 1650 has gone", "1750 has added nothing since 12:31", "that clustering has stopped growing", "it is thinning out", "it is dying down" all describe what the board DID and must be KEPT — a fading crowd is a measured past change like any other, and "dying down" is its plain-English name, not a prediction that it keeps fading. What must still be deleted is a VERDICT laid on top of the fact: "it was never real", "so that was noise", "that was fake", "I was wrong to call it". Those grade the earlier reading rather than describing the board. Keep the fact, cut the ruling.
