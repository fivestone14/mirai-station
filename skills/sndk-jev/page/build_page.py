...
<div class="rv"><code class="qid">weight per question</code><span class="opt">0 to 1</span><span class="why">mutual information between what the question picked afresh and the band, over the best question\'s among those with 40 fresh pairs of their own; a question stays 1.0 until it has 40 pairs; under 0.5 its sentence is left out of step 3 but it is still asked, so it can climb back; a held answer never pairs</span></div>
<div class="rv"><code class="qid">not graded</code><span class="opt">skipped</span><span class="why">a horizon ending more than 2 minutes past the close (one inside those 2 minutes is graded at the closing bar), or a day with no bars; a record none of whose horizons can be graded is closed out, never retried; a row is graded once however many times the service ran on it</span></div>
<div class="rv"><code class="qid">cadence</code><span class="opt">30 / 60 / 120 min</span><span class="why">recounted once a day from the previous day's runs: the 25th percentile of how long each question's answer held, halved and snapped; never changed all day gives 60 (three hours of runs) or 120 (five hours, ten reads); under six reads keeps the last value. A change is the whole answer moving, not the picked word flipping: the probabilities of two consecutive answers are compared option by option and a total shift of 0.3 or more counts (heavy 0.90 to heavy 0.55 is a change, 0.90 to 0.88 is not)</span></div>
